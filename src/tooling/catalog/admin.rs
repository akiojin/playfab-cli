...
pub fn tools() -> Vec<super::ToolSpec> {
                ...
                ("Bans", object_array_prop(
                    ...
                    object_schema(
                        ...
                        vec![
                            ...
                            ("DurationInHours", optional(integer_prop("Duration of the ban in hours; permanent if not set"))),
                        ],
                        vec!["PlayFabId"],
                    ),
                )),
                ...
                ("Bans", object_array_prop(
                    ...
                    object_schema(
                        ...
                        vec![
                            ...
                            ("Expires", optional(string_prop("Expiration date (ISO 8601)"))),
                            ("Permanent", optional(boolean_prop("Whether the ban is permanent"))),
                            ("Active", optional(boolean_prop("Whether the ban is currently active"))),
                        ],
                        vec!["BanId"],
                    ),
                )),
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("TitleDisplayName", optional(string_prop("Title-specific display name"))),
            ],
            vec![],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("PlayFabId", string_prop("PlayFab ID of the user")),
                ("ProfileConstraints", optional(any_object_prop("Profile constraints to limit returned data"))),
            ],
            vec!["PlayFabId"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("SecondsToLive", optional(integer_prop("Number of seconds to keep the continuation token alive"))),
                ("MaxBatchSize", optional(integer_prop("Maximum number of players to return"))),
                ("ContinuationToken", optional(string_prop("Continuation token for paging"))),
            ],
            vec!["SegmentId"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("IfChangedFromDataVersion", optional(integer_prop("Return data only if changed from this version"))),
            ],
            vec!["PlayFabId"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("PlayFabId", string_prop("PlayFab ID of the user")),
                ("Data", optional(any_object_prop("Key-value pairs to create/update"))),
                ("KeysToRemove", optional(string_array_prop("Keys to remove"))),
                ("Permission", optional(string_enum_prop("Permission for the data", &["Private", "Public"]))),
            ],
            vec!["PlayFabId"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("Keys", optional(string_array_prop("Specific keys to retrieve"))),
                ("OverrideLabel", optional(string_prop("Optional override label for title data"))),
            ],
            vec![],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("Value", optional(string_prop("Value to set; null removes the key"))),
                ("OverrideLabel", optional(string_prop("Optional override label for title data"))),
            ],
            vec!["Key"],
        ),
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("Keys", optional(string_array_prop("Specific keys to retrieve"))),
                ("OverrideLabel", optional(string_prop("Optional override label"))),
            ],
            vec![],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("PolicyVersion", integer_prop("The current policy version for optimistic concurrency")),
                ("OverwritePolicy", boolean_prop("Whether to overwrite or append to the existing policy")),
                ("Statements", object_array_prop(
                    "Policy statements",
                    object_schema(
                        "Policy statement",
                        vec![
                            ...
                            ("Condition", optional(any_object_prop("Conditions for the statement"))),
                        ],
                        vec!["Resource", "Action", "Effect", "Principal"],
                    ),
                )),
            ],
            vec!["PolicyName", "PolicyVersion", "OverwritePolicy", "Statements"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("CatalogVersion", optional(string_prop("Catalog version for the store"))),
            ],
            vec!["StoreId"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("CatalogVersion", optional(string_prop("Catalog version"))),
                ("Store", object_array_prop(
                    "Array of store items",
                    any_object_prop("Store item definition"),
                )),
                ("MarketingData", optional(any_object_prop("Store marketing data"))),
            ],
            vec!["StoreId", "Store"],
        ),
    });
                ...
                ("VirtualCurrencies", object_array_prop(
                    ...
                    object_schema(
                        ...
                        vec![
                            ...
                            ("InitialDeposit", optional(integer_prop("Initial amount granted to new users"))),
                            ("RechargeRate", optional(integer_prop("Rate at which currency recharges per day"))),
                            ("RechargeMax", optional(integer_prop("Maximum amount of currency that can accumulate via recharge"))),
                        ],
                        vec!["CurrencyCode"],
                    ),
                )),
            ...
            vec![
                ("VirtualCurrencies", object_array_prop(
                    ...
                    object_schema(
                        "Virtual currency",
                        vec![
                            ("CurrencyCode", string_prop("Currency code to remove")),
                        ],
                        vec!["CurrencyCode"],
                    ),
                )),
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("PlayFabId", string_prop("PlayFab ID of the user")),
                ("VirtualCurrency", string_prop("Name of the virtual currency (2-character code)")),
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("Publish", optional(boolean_prop("Whether to publish the revision immediately"))),
                ("DeveloperPlayFabId", optional(string_prop("PlayFab ID of the developer initiating the request"))),
            ],
            vec!["Files"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("ContentType", optional(string_prop("MIME type of the content"))),
            ],
            vec!["Key"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("Description", optional(string_prop("Description of the task"))),
                ("IsActive", optional(boolean_prop("Whether the task is active"))),
                ("Schedule", optional(string_prop("Cron expression for the schedule"))),
                ("Parameter", object_schema(
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("IsActive", optional(boolean_prop("Whether the task is active"))),
                ("Schedule", optional(string_prop("Cron expression for the schedule"))),
                ("Type", optional(string_enum_prop("Task type", &["ActionsOnPlayerSegment", "CloudScript", "InsightsScheduledScaling"]))),
                ("Parameter", optional(any_object_prop("Task-specific parameter object"))),
            ],
            vec!["Name"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("CatalogVersion", optional(string_prop("Catalog version"))),
                ("Tables", object_array_prop(
                    "Array of random result tables to update",
                    object_schema(
                        "Random result table",
                        vec![
                            ("TableId", string_prop("Table ID")),
                            ("Nodes", object_array_prop(
                                "Table entries",
                                object_schema(
                                    "Result table node",
                                    vec![
                                        ("ResultItemType", string_enum_prop("Type of the result", &["ItemId", "TableId"])),
                                        ("ResultItem", string_prop("ID of the item or table")),
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("VersionChangeInterval", optional(string_enum_prop("Interval for version changes", &["Never", "Hour", "Day", "Week", "Month"]))),
                ("AggregationMethod", optional(string_enum_prop("Aggregation method", &["Last", "Min", "Max", "Sum"]))),
            ],
            vec!["StatisticName"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("Subject", optional(string_prop("Subject of the notification"))),
                ("Package", optional(any_object_prop("Push notification package (platform-specific)"))),
                ("TargetPlatforms", optional(string_array_prop("Target platforms for the notification"))),
            ],
            vec!["Recipient"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("Platform", string_prop("Platform for the push notification")),
                ("Key", optional(string_prop("Credential key for the notification platform"))),
                ("OverwriteOldARN", optional(boolean_prop("Whether to overwrite old ARN"))),
                ("Credential", optional(string_prop("Credential for the notification platform"))),
            ],
            vec!["Name", "Platform"],
        ),
    });
                ...
                ("ItemGrants", object_array_prop(
                    ...
                    object_schema(
                        ...
                        vec![
                            ...
                            ("Annotation", optional(string_prop("String for the annotation of the grant"))),
                            ("CharacterId", optional(string_prop("Character ID to grant to"))),
                            ("Data", optional(any_object_prop("Key-value pairs for custom data"))),
                            ("KeysToRemove", optional(string_array_prop("Keys to remove from custom data"))),
                        ],
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("CharacterId", optional(string_prop("Character ID that owns the item"))),
            ],
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ("PlayFabId", string_prop("PlayFab ID of the user")),
                ("ItemInstanceId", string_prop("Item instance ID")),
                ("UsesToAdd", integer_prop("Number of uses to add (can be negative to remove)")),
            ],
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("PlayerSecret", optional(string_prop("Player secret to set; null generates a new one"))),
            ],
            vec!["PlayFabId"],
        ),
    });
    ...
    t.push(super::ToolSpec {
        ...
        parameters: object_schema(
            ...
            vec![
                ...
                ("GameMode", string_prop("Game mode for the registered server")),
                ("LobbyId", optional(string_prop("Lobby ID"))),
                ("Region", string_enum_prop("Region where the server is located", &[
                    "USCentral", "USEast", "EUWest", "Singapore", "Japan", "Brazil", "Australia",
                ])),
                ("ServerIPV4Address", optional(string_prop("IPv4 address of the server"))),
                ("ServerIPV6Address", optional(string_prop("IPv6 address of the server"))),
                ("ServerPort", optional(string_prop("Port of the server"))),
                ("ServerPublicDNSName", optional(string_prop("Public DNS name of the server"))),
                ("Tags", optional(any_object_prop("Tags for the game server"))),
            ],
