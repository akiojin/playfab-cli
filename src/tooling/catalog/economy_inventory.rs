            ...
            (
                ...
                optional(object_schema(
                    ...
                    vec![
                        (
                            "Type",
                            string_prop("Type of alternate ID (e.g. FriendlyId, MarketplaceId)"),
                        ),
...
fn price_amount_schema() -> serde_json::Value {
    object_schema(
        ...
        vec![
            (
                "ItemId",
                string_prop("ID of the currency or item used as payment"),
            ),
            ("Amount", integer_range_prop("Amount to pay", Some(1), None)),
            (
                "StackId",
                optional(string_prop("Stack ID of the currency item")),
            ),
        ],
        vec!["ItemId", "Amount"],
    )
...
pub fn tools() -> Vec<super::ToolSpec> {
    vec![
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        "collectionId",
                        optional(string_prop("Collection ID (default collection if omitted)")),
                    ),
                    (
                        "customTags",
                    ...
                    (
                        "durationInSeconds",
                        optional(integer_prop("Duration in seconds for expiring items")),
                    ),
                    (
                        "idempotencyId",
                        optional(string_prop("Idempotency ID for the request")),
                    ),
                    (
                        "newStackValues",
                        optional(any_object_prop("Initial values for a new stack if created")),
                    ),
                ],
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        "amount",
                        integer_range_prop("Amount to subtract", Some(1), None),
                    ),
                    ...
                    (
                        "deleteEmptyStacks",
                        optional(boolean_prop("Delete stack when quantity reaches zero")),
                    ),
                    (
                        "durationInSeconds",
                        optional(integer_prop("Duration in seconds")),
                    ),
                    (
                        "idempotencyId",
                        optional(string_prop("Idempotency ID for the request")),
                    ...
                    (
                        ...
                        object_schema(
                            ...
                            vec![
                                ...
                                (
                                    "DisplayProperties",
                                    optional(any_object_prop("Display properties to update")),
                                ),
                            ],
                            vec!["Id"],
                        ),
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    (
                        "entity",
                        entity_key_schema("Entity whose inventory to retrieve"),
                    ),
                    ("collectionId", optional(string_prop("Collection ID"))),
                    (
                        "count",
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    (
                        "entity",
                        entity_key_schema("Entity whose collection IDs to retrieve"),
                    ),
                    (
                        "count",
                        optional(integer_range_prop(
        ...
        super::ToolSpec {
            ...
            description: "Execute multiple inventory operations atomically (Economy v2)"
                .to_string(),
            api_group: "Inventory".to_string(),
            ...
            input_schema: object_schema(
                ...
                vec![
                    (
                        "entity",
                        entity_key_schema("Entity to perform operations on"),
                    ),
                    (
                        "operations",
                        object_array_prop(
                            ...
                            object_schema(
                                ...
                                vec![
                                    (
                                        ...
                                        optional(object_schema(
                                            ...
                                            vec![
                                                ...
                                                (
                                                    "Amount",
                                                    integer_range_prop("Amount", Some(1), None),
                                                ),
                                                (
                                                    "DurationInSeconds",
                                                    optional(integer_prop("Duration in seconds")),
                                                ...
                                                (
                                                    "NewStackValues",
                                                    optional(any_object_prop("New stack values")),
                                                ),
                                            ],
                                            vec!["Item", "Amount"],
                                        )),
                                    ...
                                    (
                                        ...
                                        optional(object_schema(
                                            ...
                                            vec![
                                                ...
                                                (
                                                    "DeleteEmptyStacks",
                                                    optional(boolean_prop("Delete empty stacks")),
                                                ),
                                            ],
                                            vec!["Item", "Amount"],
                                        )),
                                    ...
                                    (
                                        ...
                                        optional(object_schema(
                                            "Delete operation",
                                            vec![("Item", item_ref_schema("Item to delete"))],
                                            vec!["Item"],
                                        )),
                                    ),
                                    (
                                    ...
                                    (
                                        ...
                                        optional(object_schema(
                                            ...
                                            vec![
                                                ...
                                                (
                                                    "GivingEntity",
                                                    entity_key_schema("Source entity"),
                                                ),
                                                (
                                                    "ReceivingEntity",
                                                    entity_key_schema("Destination entity"),
                                                ),
                                            ],
                                            vec![
                                                "Item",
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        "amount",
                        integer_range_prop("Amount to purchase", Some(1), None),
                    ),
                    (
                        "priceAmounts",
                        object_array_prop("Price amounts to pay", price_amount_schema()),
                    ),
                    ("collectionId", optional(string_prop("Collection ID"))),
                    (
                        "customTags",
                    ...
                    (
                        "deleteEmptyStacks",
                        optional(boolean_prop("Delete empty stacks after purchase")),
                    ),
                    (
                        "idempotencyId",
                        optional(string_prop("Idempotency ID for the request")),
                    ...
                    (
                        "newStackValues",
                        optional(any_object_prop("Initial values for new stack")),
                    ),
                    (
                        "storeId",
                        optional(string_prop("Store ID for store-specific pricing")),
                    ),
                ],
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        ...
                        string_prop("Nintendo service account ID token"),
                    ),
                    ("collectionId", optional(string_prop("Collection ID"))),
                    (
                        "customTags",
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        "authorizationCode",
                        string_prop("PlayStation authorization code"),
                    ),
                    (
                        "serviceLabel",
                        optional(string_prop("PlayStation service label")),
                    ),
                    ("collectionId", optional(string_prop("Collection ID"))),
                    (
                        "customTags",
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        "receivingEntity",
                        entity_key_schema("Entity receiving the items"),
                    ),
                    ("item", item_ref_schema("Item to transfer")),
                    (
                        "amount",
                        integer_range_prop("Amount to transfer", Some(1), None),
                    ),
                    (
                        "givingCollectionId",
                        optional(string_prop("Source collection ID")),
                    ),
                    (
                        "receivingCollectionId",
                        optional(string_prop("Destination collection ID")),
                    ),
                    (
                        "customTags",
                        optional(any_object_prop("Custom tags for the request")),
                    ...
                    (
                        "deleteEmptyStacks",
                        optional(boolean_prop("Delete empty stacks after transfer")),
                    ),
                    (
                        "idempotencyId",
                        optional(string_prop("Idempotency ID for the request")),
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    (
                        "entity",
                        entity_key_schema("Entity whose transaction history to retrieve"),
                    ),
                    ("collectionId", optional(string_prop("Collection ID"))),
                    (
                        "count",
                    ...
                    (
                        "orderBy",
                        optional(string_prop("Order by clause (e.g. 'timestamp desc')")),
                    ),
                ],
                vec!["entity"],
            ),
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    (
                        "entity",
                        entity_key_schema("Entity that owns the operation"),
                    ),
                    ("collectionId", optional(string_prop("Collection ID"))),
                    (
                        "customTags",
        ...
        super::ToolSpec {
            ...
            input_schema: object_schema(
                ...
                vec![
                    ...
                    (
                        "receivingEntity",
                        entity_key_schema("Entity receiving items"),
                    ),
                    (
                        "operations",
                        object_array_prop(
                        ...
                        object_array_prop(
                            ...
                            object_schema(
                                ...
                                vec![
                                    (
                                        "PlayFabId",
                                        string_prop("PlayFab ID of the user to grant items to"),
                                    ),
                                    (
                                        "items",
                                        object_array_prop(
        ...
        super::ToolSpec {
            ...
            description: "Get Microsoft Store access tokens for inventory operations (Economy v2)"
                .to_string(),
            api_group: "Inventory".to_string(),
